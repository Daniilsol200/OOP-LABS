// OrganizationDao.cs (без изменений)
using System;
...
namespace EquipmentRegistryLib
{
    public class OrganizationDao : DaoBase, IDao<Organization>
    {
        ...
        public int Create(Organization entity)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(entity.OrgName))
                    throw new ArgumentException("Название организации обязательно для заполнения.");
